...
if($var='#\[img=(.+?)\]#is'){
$var = preg_replace('#\[img=(.+?)\]#is', '<a href="\1"><img src="\1" alt="TaMk.tK"title="TaMk.tK" border="0" width="110"/></a><br/>', $var);
...
////BBCODE URL
''.($user_id ? '<a href="\\1">\\2</a>':'[Bạn cần phải đăng nhập để xem liên kết]').'',
''.($user_id ? '<a href="\\1">\\2</a>':'[Bạn cần phải đăng nhập để xem liên kết]').'',


////BBCODE HÌNH ẢNH
'<a href="\1"><img src="\1" alt="TaMk.tK"title="TaMk.tK" border="0" width="110"/></a><br/>',
'<a href="\1"><img src="\1" alt="TaMk.tK"title="TaMk.tK" border="0" width="110"/></a><br/>',
'<a href="\1"><img src="\1" alt="TaMk.tK"title="TaMk.tK" border="0" width="110"/></a><br/>'
...
<a href="javascript:tag(\'[img]\', \'[/img]\', \'\')"><img src="' . self::$system_set['homeurl'] . '/images/bb/im.gif" alt="url" title="Dẫn link ảnh" border="0"/></a>
...
return $out . '<br />';
$var = preg_replace('#\[code\](.*?)\[/code\]#si', '<div
class="codetitle">Mã</div><textarea cols="3" rows="7">\1</
textarea>', $var);
}
}
