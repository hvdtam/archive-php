...
echo'<div class="phdr">Thống kê điện thoại / trình duyệt</div>';
    ...
    while($result_array = mysql_fetch_array($query)) {
  	...
  	echo'<div class="menu"><img src="tmp/model.png" alt="Lịch trình"/></div>';
    echo '<div class="gmenu"><h3>Nhiều hơn</h3>';
		...
		if($phones[13] > 0){
		  $col[] = $phones[13];
		    $name[] = 'Компьютеры';
			echo'<li> <a href="?act=phone&amp;model=komp">Компьютеры</a> ('.$phones[13].')</li>'; }
