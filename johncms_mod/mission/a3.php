...
echo '<div class="gray"><b>Nhiệm vụ 3: Lời Thách Thức Của Lee</b></div>';

switch($act){
case 'm' :
if($user['postforum']>=130 && $user['mission']==2){
echo '<div> <form action="a3.php?act=mbuy" name="m" method="post">
<input type="radio" name="m" value="4500"/>  Nhận phần thưởng 4.500 VND<br/>
...
echo '<div class="menu">Nhiệm vụ hoàn thành, bạn nhận được 4.500 VND!</div>';
...
header('Location:../mission/a3.php?act=mbuyo');
exit();
