...
if (preg_match("|xemboi|",$msg) ||preg_match("|Xemboi|",$msg) || preg_match("|XEMBOI|",$msg) ||preg_match("|Xem bói|",$msg) || preg_match("|Xem boi|",$msg) || preg_match("|xem boi|",$msg) ||preg_match("|BÓI|",$msg) ||preg_match("|bói|",$msg)) {
$listboibai = array(
...
"Con bốc được lá [b][red]4♣[/b][/red] 
Để thầy xem...<h4><q style='color:green;font-style:italic;padding:20px;'>Đây là một quân bài cảnh báo. Theo thày tính thì thời gian này con phải cẩn thận không có đứa gian dối, phản bội đấy. Nếu con mà kí cọt gì cũng phải đọc lại, không chủ quan nghe chưa. Chúc con may mắn!",
"Con bốc được lá [b][red]4♠[/b][/red] 
Để thầy xem...<h4><q style='color:green;font-style:italic;padding:20px;'>Con à, quân này nó hay đi liền với cả muộn phiền, rắc rối. Thày nghĩ con nên cẩn thận trong chi tiêu, với cả đề phòng mất của. Nói chung thì cũng không có gì nguy hiểm lắm, con cứ an tâm đừng lo nghĩ nhiều, mấy hôm nữa vận chuyển sao dời mọi thứ sẽ đâu vào đấy thôi.",
...
if (preg_match("|thầy phán|",$msg) ||preg_match("|thầy ơi|",$msg) || preg_match("|thầy ui|",$msg) ||preg_match("|phán đâu|",$msg) || preg_match("|thầy ngu|",$msg) ||preg_match("|thay phan ngu|",$msg) || preg_match("|thầy xem con|",$msg) || preg_match("|thầy|",$msg) ||preg_match("|bao giờ|",$msg) || preg_match("|bao gio|",$msg) || preg_match("|con chào thầy|",$msg) || preg_match("|phan|",$msg) || preg_match("|thay|",$msg) ||preg_match("|thầy ngu quá|",$msg) ||preg_match("|thay ngu|",$msg)) {
$listtraloi = array(
