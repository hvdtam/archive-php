...
*/
if ($wapdet<>"wap") {
echo '<br/> <a href="'.$home.'/tmod.php?mod=wap">WAP</a> | WEB';
} else {
echo '<br/> WAP | <a href="'.$home.'/tmod.php?mod=web">WEB</a>';
}

echo '<div><small>&copy; <a href="http://x10wap.tk">TaMk</a></small></div>';
