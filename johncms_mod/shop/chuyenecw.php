...
echo '<div class="gray">Thẻ chuyển đổi đơn vị VND!</div>';

echo '<span class=red><a href="../shop/dgvg.php?act=doi"><b> Chuyển VND sangVGold</b></a></span></br>';
echo '<span class=red><a href="../shop/vgdg.php?act=doi"><b> ChuyểnVGold sang VND</b></a></span>';
