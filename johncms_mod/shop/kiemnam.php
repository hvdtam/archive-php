...
if($user['sex']==zh) echo '<p>Không mua đồ khác giới tính</p>';
else {
switch ($act) {
	 ...
	 case 'buy':
	  ...
	  //Панда
		  echo '<img src="/item/kiem/boy/item/1.png" alt="" /><br />';
		   echo '<p>Kiếm thần [10000 VGold]<br><font color="red">Điểm kinh nghiệm: 105000exp</font></p>';
		  ...
		  echo '- <a href="?act=ok&amp;select=1">Mua Kiếm</a><br />';
			...
			echo 'Chưa đủ tiền hoặc điểm kinh nghiệm<br />';
                           ...
                           //птица
		  echo '<img src="/item/kiem/boy/item/2.png" alt="" /><br />';
		   echo '<p>Bảo đao [100000 VGold]<br><font color="red">Điểm kinh nghiệm: 205000exp</font></p>';
            if ($user['vgold'] >= 100000 && $exp >=205000)	{	   
		  echo '- <a href="?act=ok&amp;select=2">Mua Kiếm</a><br />';
		    }else{
			echo 'Chưa đủ tiền hoặc điểm kinh nghiệm<br />';
			}
