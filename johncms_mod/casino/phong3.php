...
echo '<b> Loại 6 con</b><br/><br/>';
echo '<b> Phòng 3</b><br/><br/>';
        ...
        case "choice":
            if (isset($_SESSION['naperstki'])) {
                ...
                unset($_SESSION['naperstki']);
            		   ...
            		   echo '<a href="phong3.php?act=go&amp;thimble=1&amp;rand=' . $rand .
                '"><img src="1.gif" alt=""/></a>
				<a href="phong3.php?act=go&amp;thimble=2&amp;rand=' . $rand .
                '"><img src="2.gif" alt=""/></a>
				<a href="phong3.php?act=go&amp;thimble=3&amp;rand=' . $rand .
                '"><img src="3.gif" alt=""/></a><br/><br/>
				<a href="phong3.php?act=go&amp;thimble=4&amp;rand=' . $rand .
                '"><img src="5.gif" alt=""/></a>
				<a href="phong3.php?act=go&amp;thimble=5&amp;rand=' . $rand .
                '"><img src="6.gif" alt=""/></a>
				<a href="phong3.php?act=go&amp;thimble=6&amp;rand=' . $rand .
                '"><img src="7.gif" alt=""/></a><br/><br/>

				Chọn một một trong sáu con ở trên<br/>
			Bạn có: ' . $datauser['balans'] . ' VND<br/>
			<br/><a href="phong3.php">Quay lại</a>';
        ...
        case "go":
            ...
            if ($datauser['balans'] >= $money_minus) {
                ...
                if (intval($_SESSION['naperstki']) < "1") {
                    ...
                    if ($rand_thimble == "3") {
                        echo '<img src="4.gif" alt=""/><br/>';
                    } else {
                        echo '<img src="3.gif" alt=""/><br/>';
                    }
                ...
                echo '<br/><b><a href="phong3.php?act=choice&amp;rand=' . $rand .
...
<b><a href="phong3.php?act=choice">Bắt đầu Chơi</a></b><br/>
<a href="phong3.php?act=faq">Trợ giúp</a><br/>
Bạn có: ' . $datauser['balans'] . ' VND<br/>';
