...
$tinphp = str_replace('<a href="/">M.TIN247.COM</a>','<a href="/">TIN.MGIAITRI.BIZ</a>',$tinphp);
...
$tinphp = laynoidung($source, $batdau, $ketthuc);
$tinphp = str_replace('<a href="/">M.TIN247.COM</a>','<a href="http://' . $_SERVER['HTTP_HOST'] . '">3G</a>',$tinphp);
$tinphp = str_replace('<a href="','<a href="/?s=m&w=',$tinphp);
echo $tinphp;
