...
echo 'Chữ kí của bạn quá dài,nó không thể nhiều hơn 150 kí tự.<br/><a href="chuki.php?">Làm lại</a>';
}else{
if ($datauser['balans'] >= 5000)
{
mysql_query("UPDATE `users` SET `chuki`='".$msg."',
`balans`=`balans` - 5000 WHERE `id`='".$user_id."'");
...
echo '' .
'<div class="gmenu">Giá: 5000 VND<br/><form method="post">' .
