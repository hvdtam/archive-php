...
echo '<div class="gray"><b>Nhiệm vụ 5: Cô nàng đỏng đảnh</b></div>';

switch($act){
case 'm' :
if($user['pet']>=1 && $user['mission']==4){
echo '<div> <form action="a5.php?act=mbuy" name="m" method="post">
<input type="radio" name="m" value="1000"/>  Nhận phần thưởng 1.000 VND<br/>
...
echo '<div class="menu">Nhiệm vụ hoàn thành, bạn nhận được 1.000 VND!</div>';
...
header('Location:../mission/a5.php?act=mbuyo');
exit();
