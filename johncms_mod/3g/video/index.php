...
connectdb();
?>
<div class="main2">Video</div>
<form method="get" action="search.php" >Tìm kiếm:<a href="keyword.php">(?)</a><br/>
      <input type="text" name="vq" maxlength="128" size="15"style="color:#333;padding:0;font-family:Verdana, Arial, sans-serif;width:65%" />
      <input type="submit" name="submit" value="Tìm kiếm" style="padding:0;color:black;margin-top:2px;font-size:100%" /> 
</form>
</div>
<br/>
<?php
