...
echo '<div class="gray">Mua item quần giá 50.000 VND!</div>';
////////////////////////////
switch($act){
case 'quan' :
if($user['balans']>=0){
echo '<div> <form action="quannam.php?act=quanbuy" name="quan" method="post">
<input type="radio" name="quan" value="1"/> <img src="../item/quan/boy/item/1.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="quan" value="2"/> <img src="../item/quan/boy/item/2.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="quan" value="3"/> <img src="../item/quan/boy/item/3.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="quan" value="4"/> <img src="../item/quan/boy/item/4.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="quan" value="5"/> <img src="../item/quan/boy/item/5.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="quan" value="6"/> <img src="../item/quan/boy/item/6.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="quan" value="7"/> <img src="../item/quan/boy/item/7.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="quan" value="8"/> <img src="../item/quan/boy/item/8.png" align="middle"/>&nbsp;<br/>
...
$quan = ($_POST['quan']); 
mysql_query("UPDATE `users` SET `quan` = '$quan' ,`balans`=`balans`-50000  WHERE `id` = '$user_id' LIMIT 1");
...
header('Location:../shop/quannam.php?act=quanbuyo');
exit();
