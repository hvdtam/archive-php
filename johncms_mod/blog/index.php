...
if(isset($_GET['thich'])){$tit = 'Top Truyện Hay, Top Truyện Hot, Truyện Hay Nhất, Wap Đọc Truyện';
...
$tit = (isset($_GET['p']) ? 'Trang '.$_GET['p'].' - ':NULL).b_set('title').' , Wap Đọc Truyện, Wap Xem Truyện, Truyện Mobile, Wap Truyện Hay';
...
<div class="main"><img src="img/next.png"> <a href="top-like.html">Top yêu thích</a></div>
<div class="main"><img src="img/next.png"> <a href="top-view.html">Top xem nhiều</a></div>
<div class="menu">&rsaquo;<b> Thống Kê</b></div>
<div class="main"><img src="img/next.png"> Thể loại: '.(int)mysql_result(mysql_query("select count('id') from theloai"),0).'</div>
<div class="main"><img src="img/next.png"> Bài đăng: '.(int)mysql_result(mysql_query("select count('id') from truyen"),0).'</div>
<div class="main"><img src="img/next.png"> <a href="comment">Các bình luận</a> '.(int)mysql_result(mysql_query("select count('id') from comment"),0).' </div>';
require_once('inc/duoi.php');
?>
