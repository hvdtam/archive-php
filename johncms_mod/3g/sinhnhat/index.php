...
?><?php
include '../head.php';
echo '<form action="xong.php" method="post">
Họ và Chữ đệm Tên bạn:<br><input type="text" name="name"><br>
Tên Của Bạn:<br><input type="text" name="ten"><br>
Sinh nhật của (Họ&đệm):<br><input type="text" name="name1"><br>
Sinh nhật (Tên) :<br><input type="text" name="ten1"><br>
...
<br>
<input type="submit" value="Tạo wapsite" name="submit"></form>';
include '../foot.php';
?>