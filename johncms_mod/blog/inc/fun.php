...
"/\[img\](.*?)\[\/img\]/is" => "<div align=\"center\"><img src=\"$1\" style=\"width:50%\" alt=\"Ảnh Minh Hoạ\"><br><a href=\"$1\">Tải ảnh gốc</a></div>",
...
$txt = str_replace(':buon:', '<img src="../img/smi/buon.gif">', $txt);
$txt = str_replace(':im:', '<img src="../img/smi/im.gif">', $txt);
$txt = str_replace(':D', '<img src="../img/smi/D.gif">', $txt);
$txt = str_replace(':buc:', '<img src="../img/smi/buc.gif">', $txt);
$txt = str_replace(':-?', '<img src="../img/smi/hoi.gif">', $txt);
