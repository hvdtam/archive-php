...
echo '<div class="gray">Mua item mũ giá 80.000 VND!</div>';
////////////////////////////
switch($act){
case 'mu' :
if($user['balans']>=0){
echo '<div> <form action="munam.php?act=mubuy" name="mu" method="post">
<input type="radio" name="mu" value="1"/> <img src="../item/toc/boy/item/1.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="2"/> <img src="../item/toc/boy/item/2.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="3"/> <img src="../item/toc/boy/item/3.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="4"/> <img src="../item/toc/boy/item/4.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="5"/> <img src="../item/toc/boy/item/5.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="6"/> <img src="../item/toc/boy/item/6.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="7"/> <img src="../item/toc/boy/item/7.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="8"/> <img src="../item/toc/boy/item/8.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="9"/> <img src="../item/toc/boy/item/9.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="mu" value="10"/> <img src="../item/toc/boy/item/10.png" align="middle"/>&nbsp;<br/>
...
break;
case 'mubuy' :
if($user['balans']>=80000 && $user['sex']==m){
$mu = ($_POST['mu']); 
mysql_query("UPDATE `users` SET `toc` = '$mu' ,`balans`=`balans`-80000  WHERE `id` = '$user_id' LIMIT 1");
...
header('Location:../shop/munam.php?act=mubuyo');
exit();

}else{
echo '<div class="menu">Bạn không được mua đồ khác giới tính, Bạn không đủ số VND hoặc VGold, hãy kiểm tra lại và liên hệ với Admin để nạp thẻ!</div>';
}
break;
case 'mubuyo' :
echo '<div class="menu">Giao dịch thành công. Bạn đã nhận được item mũ, hãy kiểm tra tủ đồ!</div>';
