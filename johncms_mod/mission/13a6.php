...
echo '<div> <form action="13a6.php?act=mbuy" name="m" method="post">
...
echo '<div class="menu">Bạn lấy phải rìu sắt đôi giả, bạn bị trừ 2.000 Dgold!</div>';
...
header('Location:../mission/13a6.php?act=mbuyo');
