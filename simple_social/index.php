<?php
include 's2u.firewall_system.php';
...
<div class="main">» <a href="tim.php">Tìm kiếm</a></div><div class="main">» <a href="top-like.html">Top yêu thích</a></div>
<div class="main">» <a href="top-view.html">Top xem nhiều</a></div>
<div class="menu">&rsaquo;<b> Thống Kê</b></div>
<div class="main">» Thể loại: <a href="theloai.html">'.(int)mysql_result(mysql_query("select count('id') from theloai"),0).'</a></div>
...
<div class="xanh">
Lk: <a href="http://tamk.wapka.mobi">TaMk</a>, <a href="http://wapbee.net">WapBee</a>, <a href="http://yeuvn.tk">YêuVN</a></div>';
require_once('inc/duoi.php');
?>
