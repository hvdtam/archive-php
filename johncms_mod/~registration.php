...
mysql_query("insert into `privat` values(0,'" . mysql_real_escape_string($lat_nick) . "','".$msg."','" . time() . "','TaMk','in','no','Chào','0','','','','" . mysql_real_escape_string($fname) . "');");
$botnew = 'Chào mừng [red]' . $reg_nick . '[/red] đã gia nhập vào wap chat :bibo:';
if ($botnew) {
...
'</p>' .
'<p><h3>Mật khẩu: (2 - 20 ký tự)</h3><hr/>Không hỗ trợ ký tự đặc biệt' .
