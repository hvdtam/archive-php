...
echo '<div class="gray">Mua item giầy giá 40.000 VND!</div>';
////////////////////////////
switch($act){
case 'giay' :
if($user['balans']>=0){
echo '<div> <form action="giaynam.php?act=giaybuy" name="giay" method="post">
<input type="radio" name="giay" value="1"/> <img src="../item/giay/boy/item/1.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="giay" value="2"/> <img src="../item/giay/boy/item/2.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="giay" value="3"/> <img src="../item/giay/boy/item/3.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="giay" value="4"/> <img src="../item/giay/boy/item/4.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="giay" value="5"/> <img src="../item/giay/boy/item/5.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="giay" value="6"/> <img src="../item/giay/boy/item/6.png" align="middle"/>&nbsp;<br/>
<input type="radio" name="giay" value="7"/> <img src="../item/giay/boy/item/7.png" align="middle"/>&nbsp;<br/>
...
$giay = ($_POST['giay']); 
mysql_query("UPDATE `users` SET `giay` = '$giay' ,`balans`=`balans`-40000  WHERE `id` = '$user_id' LIMIT 1");
...
header('Location:../shop/giaynam.php?act=giaybuyo');
exit();
