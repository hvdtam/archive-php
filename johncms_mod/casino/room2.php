...
if (!empty($_SESSION['uid'])) {
    ...
    switch ($act) {
        ...
        case "choice":
            ...
            echo '<a href="room2.php?act=go&amp;thimble=1&amp;rand=' . $rand .
                '"><img src="1.gif" alt=""/></a>
				<a href="room2.php?act=go&amp;thimble=2&amp;rand=' . $rand .
                '"><img src="2.gif" alt=""/></a>
				<a href="room2.php?act=go&amp;thimble=3&amp;rand=' . $rand .
                '"><img src="3.gif" alt=""/></a><br/><br/>
				Chọn một một trong ba con<br/>
			Bạn có: ' . $datauser['balans'] . ' VND<br/>
			<br/><a href="room2.php">Quay lại</a>';
        ...
        case "go":
            ...
            if ($datauser['balans'] >= $money_minus) {
                ...
                echo '<br/><b><a href="room2.php?act=choice&amp;rand=' . $rand .
...
<b><a href="room2.php?act=choice">Bắt đầu Chơi</a></b><br/>
<a href="room2.php?act=faq">Trợ giúp</a><br/>
Bạn có: ' . $datauser['balans'] . ' VND<br/>';
