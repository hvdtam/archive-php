...
define('GOCMASTER', 1);
require('func.php');
$link = 'http://bongda.wap.vn/lichthidau/';
if($code) {
$link = 'http://bongda.wap.vn/lichthidau/ltd.jsp?code=' . $code;
}
if($code && $team) {
$link = 'http://bongda.wap.vn/lichthidau/ltd.jsp?code=' . $code . '&team=' . $team;
}
if($id && $code) {
$link = 'http://bongda.wap.vn/lichthidau/ltd.jsp?id=' . $id . '&code=' . $code;
}
...
if($code) {
$html = str_replace('tyle.jsp', 'tyle.php', $html);
...
$header = '<a href="index.html">Bóng đá</a> &raquo; Lịch thi đấu';
if($code) {
