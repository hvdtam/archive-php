...
echo '<?xml version="1.0" encoding="utf-8"?>' . "\n" .
     ...
     "\n" . '<link rel="stylesheet" href="' . $set['homeurl'] . '/theme/' . $userskin . '/style.css" type="text/css" />' .
...
-----------------------------------------------------------------
*/
echo '<div class="head"><table style="width: 100%;"><tr>' .
     '<td valign="bottom"><a href="' . $set['homeurl'] . '"><img src="' . $set['homeurl'] . '/theme/' . $userskin . '/images/logo.png" alt=""/></a></td>' .
