...
echo '<a href="6socap.php?act=go&amp;thimble=1&amp;rand=' . $rand .
'"><img src="1.gif" alt=""/></a>
<a href="6socap.php?act=go&amp;thimble=2&amp;rand=' . $rand .
'"><img src="2.gif" alt=""/></a>
<a href="6socap.php?act=go&amp;thimble=3&amp;rand=' . $rand .
'"><img src="3.gif" alt=""/></a><br/>
<a href="6socap.php?act=go&amp;thimble=4&amp;rand=' . $rand .
'"><img src="5.gif" alt=""/></a>
<a href="6socap.php?act=go&amp;thimble=5&amp;rand=' . $rand .
'"><img src="6.gif" alt=""/></a>
<a href="6socap.php?act=go&amp;thimble=6&amp;rand=' . $rand .
'"><img src="7.gif" alt=""/></a><br/><br/>

Chọn một trong sáu con ở trên<br/>
Bạn có: ' . $datauser['balans'] . ' VND<br/>
<br/><a href="6socap.php">Quay lại</a>';
...
$balans_minus_с = ($datauser['vnd'] - $balans_minus);
mysql_query("update `users` set vnd='" . $balans_minus_с . "' where id='" . $user_id .
"';");
...
echo '<br/><b><a href="6socap.php?act=choice&amp;rand=' . $rand .
...
<b><a href="6socap.php?act=choice">Bắt đầu Chơi</a></b><br/>
<a href="6socap.php?act=faq">Trợ giúp</a><br/>
Bạn có: ' . $datauser['balans'] . ' VND<br/>';
