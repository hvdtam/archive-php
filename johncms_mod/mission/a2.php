...
echo '<div class="gray"><b>Nhiệm vụ 2: Những Người Bạn</b></div>';
switch($act){
case 'm' :
if($user['postguest']>=60 && $user['mission']==1){
echo '<div> <form action="a2.php?act=mbuy" name="m" method="post">
<input type="radio" name="m" value="1500"/>  Nhận phần thưởng 1.500 VND<br/>
...
echo '<div class="menu">Nhiệm vụ hoàn thành, bạn nhận được 1.500 VND!</div>';
...
header('Location:../mission/a2.php?act=mbuyo');
exit();
