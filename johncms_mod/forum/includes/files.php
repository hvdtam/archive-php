...
-----------------------------------------------------------------
*/$req43=mysql_query("SELECT `rights`, `id` FROM `users` WHERE (id='$user_id') ");$arr56=mysql_fetch_array($req43);if ($arr56['rights'] < 6) {		    echo '<div class="rmenu">Bạn không đủ thẩm quyền để vào đây </div>';    require('../incfiles/end.php');    exit;	}
