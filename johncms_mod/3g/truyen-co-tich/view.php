...
include 'func.php';
include '../head.php';
$url= 'http://book.ipvnn.com/truyen-co-tich/'.$_GET['truyen'].'';
...
$nd = preg_replace('|<a href="/truyen-co-tich/(.*?)/"|is','<a href="/truyen-co-tich/truyen/\1.html"',$nd);
$nd = str_replace('<a href="/truyen-co-tich/">','<a href="/truyen-co-tich/index.html">',$nd);
