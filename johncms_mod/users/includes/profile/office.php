...
echo '</p><p>' .
'<div><img src="../images/admin.png" width="16" height="16"/>&#160;<a href="../chat/index.php?act=ga&amp;do=set">' . $lng['admin_club'] . '</a> (<span class="red">' . $guest . '</span>)</div>';
}
...
'<li><a href="/user/chuki.php">Thay đổi chữ kí</a></li>'.
'<li><a href="/user/perevod.php">Chuyển Tiền</a></li>'.
'<li><a href="/shop/tamtrang.php?act=tamtrang">Thay đổi Status</a></li>';
